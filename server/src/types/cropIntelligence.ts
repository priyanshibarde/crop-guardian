...
export type DiagnosisSummary = Pick<Diagnosis, 'id' | 'scanId' | 'status' | 'predictedCrop' | 'predictedDisease' | 'severity' | 'confidence' | 'modelName' | 'modelVersion' | 'createdAt' | 'updatedAt'> & { availability: DiagnosisAvailability }
